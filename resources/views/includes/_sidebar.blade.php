<div class="sidebar-wrapper sidebar-theme">
    ...
    <nav id="sidebar">
        ...
        <ul class="list-unstyled menu-categories" id="accordionExample">
            ...
            <li class="menu">
                <a href="#cours" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">
                    <div class="">
                ...
                <ul class="collapse submenu list-unstyled show" id="cours" data-parent="#accordionExample">
                    <li class="{{ Request()->path() == 'admin/niveau/create' ? 'active' : '' }}">
                        <a href="{{ route('niveau.create') }}"> Niveau </a>
                    </li>
                    <li>
                        <a href="{{ route('classe.create') }}"> Classe  </a>
                    </li>
                    <li>
                        <a href="{{ route('matiere.create') }}">Matière</a>
                    </li>
                    <li>
                        <a href="{{ route('cour.create') }}">Nouveau cours </a>
                    </li>
